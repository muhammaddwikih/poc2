...
public class SftpUtils {
	...
	// ### Constructor ###
	public SftpUtils(String host, String user) {
		this.host = host;
		this.port = 22;
		this.user = user;
		this.password = "";
	...
	public SftpUtils(String host, String user, String password) {
		this.host = host;
		this.port = 22;
		this.user = user;
	...
	public SftpUtils(String host, Integer port, String user, String password, String homePath) {
		this.host = host;
		this.port = port;
		this.user = user;
		this.password = password;
	...
	public SftpUtils(String host, Integer port, String user, String password, byte[] certificateFile, String homePath) {
		this.host = host;
		this.port = port;
		this.user = user;
		this.password = password;
